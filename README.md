...
<img src="https://metrics.lecoq.io/basmalaazabmohamed-commits?template=classic&base.header=1&base.activity=1&base.community=0&base.repositories=0&base.metadata=0&languages=1&languages.limit=8&languages.colors=github&languages.threshold=0%25&config.timezone=Africa%2FCairo" width="100%" alt="GitHub Metrics"/>
...
> 💡 The card above (stats, top languages, activity) is generated by [metrics.lecoq.io](https://metrics.lecoq.io), a free shared instance of the `lowlighter/metrics` project — used here instead of `github-readme-stats.vercel.app`, whose public server has been paused by its maintainers since April 2026. See troubleshooting notes below if a widget ever breaks again.
