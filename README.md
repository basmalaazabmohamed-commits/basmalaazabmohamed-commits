...
<img src="https://wsrv.nl/?url=github.com/basmalaazabmohamed-commits.png&w=150&h=150&fit=cover&mask=circle&maxage=7d" width="150" height="150" alt="Basmala Azab Mohamed"/>
...
<details open>
<summary><b>Click to collapse / expand project cards</b></summary>
<br>
...
<details>
<summary><b>📋 Click to expand certification table (org & year)</b></summary>
<br>
...
| AWS AI Practitioner Challenge | AWS & Udacity | 2026 |
| AI & Machine Learning | Microsoft & Sprints | 2025 |
| Building LLM Applications with Prompt Engineering | NVIDIA | 2025 |
| AI for Business | NTI & ITIDA | 2025 |
...
<img src="https://raw.githubusercontent.com/basmalaazabmohamed-commits/basmalaazabmohamed-commits/main/github-metrics.svg" width="100%" alt="GitHub Metrics"/>
...
> The card above is now generated by a **GitHub Action running in this repo** (`.github/workflows/metrics.yml`), which commits a static `github-metrics.svg` on a daily schedule. This replaces the shared `metrics.lecoq.io` endpoint, whose free public server frequently hits GitHub API rate limits and goes down — your profile no longer depends on it being up. See the included `metrics.yml` and `snake.yml` workflow files for setup.
...
<img src="https://raw.githubusercontent.com/basmalaazabmohamed-commits/basmalaazabmohamed-commits/output/github-contribution-grid-snake-dark.svg" width="100%" alt="Contribution Snake animation"/>
